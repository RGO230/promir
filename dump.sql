...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 31 2022 г., 20:35
...
CREATE TABLE `courses` (
  ...
  `sessioncount` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(24, 'чя', '<p>явыс</p>', '/uploads/639c9df9536c7.jpg', 'ЫФВ', '2022-12-16 13:34:01', '2022-12-30 13:05:13', 1000, 26, 0, 'Абонемент в женский клуб', '<p>яыс</p>', NULL, NULL),
...
--
-- Дамп данных таблицы `graphics`
--

INSERT INTO `graphics` (`id`, `time_from`, `time_to`, `dayofweek`, `created_at`, `updated_at`) VALUES
(1, '20:55:00', '19:56:00', 'Понедельник', '2022-12-30 12:56:58', '2022-12-30 13:02:28'),
(2, '19:07:00', '20:08:00', 'Суббота', '2022-12-30 13:07:38', '2022-12-30 13:12:41');
...
(39, '2022_12_28_161542_change_to_courses_table', 5),
(43, '2022_12_29_200055_create_graphics_table', 6),
(44, '2022_12_30_161721_create_consultations_table', 7);
