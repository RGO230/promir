...
<div class="container">
    <div class="row">
        <div class="card">
            ...
            <div class="card-body">
                <form enctype="multipart/form-data" method="POST" action="/graphic/{{$graphic->id}}/update">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="time" class="form-control" value="{{$graphic->time_from}}" name="time_from" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                        <input type="time" class="form-control" value="{{$graphic->time_to}}"  name="time_to" required autofocus>
                        </div>
                    </div>
